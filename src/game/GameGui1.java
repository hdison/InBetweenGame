...
public class GameGui1 extends Application	
{

	private String amount;  // variable to store amount that is bet
	private String btwnMsg = "Not between";
	private House house;
	private Card Card1;
	private Card Card2;
	private Card Card3;
	...
	public void gameDriver() throws IllegalBetException 
	{
		...
		do {
			house.playHandGUI(p1, 20); // (player, bet amount)
	...
	public void start(Stage stage) throws FileNotFoundException,  IllegalBetException 
	{
		...
		bet1Txt.setOnAction(new EventHandler<ActionEvent>() 
		{
			...
			public void handle(ActionEvent event) 
			{
				amount = bet1Txt.getText(); 
				try 
				{
					house.playHandGUI(p1, amount);	  
				}
				catch (IllegalBetException e)
				{
					System.out.println(e);
					p1Lbl.setText("YOU DON'T HAVE THAT MUCH!");
				...
				if(house.isBtwn())
				{
					...
					btwnMsg = "The third card IS in between";
				}
				else
				{
					btwnMsg = "The third card is NOT in between";
				}
